...
# --- 5. Componente de Estilos (MODIFICADO) ---
def apply_custom_styles():
    st.markdown(
        ...
        <style>
            ...
            .header-title {
                font-size: 3.8em; /* <-- CAMBIO: Fuente más grande */
                font-weight: bold;
                color: #EE7518; 
                line-height: 1.1; 
            }
            .header-subtitle {
                font-size: 2.2em; /* <-- CAMBIO: Subtítulo más grande */
                font-weight: medium;
                color: #EE7518; 
                /* Se mantiene el borde superior como separación visual */
                border-top: 1px solid rgba(238, 117, 24, 0.3); 
                padding-top: 5px;
                margin-top: 10px; /* Más margen superior */
                margin-bottom: 20px; /* <-- NUEVO: Empuja las tarjetas hacia abajo */
            }
            ...
            /* Se mantiene la regla, aunque la función st.divider() ya no se llama */
...
# --- 6. Componente Header (Contenido - MODIFICADO) ---
def Header():
    ...
    # st.divider() se ha eliminado para quitar la línea


# --- 7. Componente ServiceCard ---
def ServiceCard(service: dict, action: dict):
    """
    Renderiza la tarjeta de servicio con imagen y botón de acción (fondo naranja).
    """
